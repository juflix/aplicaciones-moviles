...
class SettingsActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        private const val SHOW_BOARD_KEY = "board"
        private const val SHOW_BOARD_DEFAULT = false
        ...
        fun getShowBoard(context: Context): Boolean {
            return PreferenceManager
                .getDefaultSharedPreferences(context)
                .getBoolean(SHOW_BOARD_KEY, SHOW_BOARD_DEFAULT)
        }
    }
}